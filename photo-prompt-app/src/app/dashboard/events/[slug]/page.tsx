...
export default function EventManagePage() {
  ...
  const bulkPrompts = useBulkPrompts({
    existingPrompts,
    onPromptsAdded: async (newPrompts) => {
      // Use bulk API to add prompts
      try {
    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-8 glass-card p-0">
          <div className="px-4 sm:px-6 py-4 border-b border-stone-200/70 flex items-center justify-between">
            ...
            <BulkPromptsDialog
              ...
              triggerButton={<BulkPromptsTrigger onClick={bulkPrompts.openDialog} />}
            />
          </div>
          <div className="p-1 sm:p-6">
            <div className="space-y-3">
              {event.prompts.map((prompt, index) => (
                <div key={prompt.id} className="flex items-start md:items-center gap-3 px-2 py-3 sm:px-3 rounded-xl ring-1 ring-stone-200 bg-white/80 flex-wrap">
              ...
              {/* Inline Add Prompt */}
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 px-2 py-3 sm:px-3 ring-1 ring-rose-200 bg-rose-50 rounded-xl">
